...
async def get_all_from_access_database(listing_num: str):
    ...
    try:
        ...
        while True:
            ...
            if offset % 50 == 0:
                os.system('cls')
                print('sending invite to everyone inside Access Database: [','# ' * int(offset / 50), '- ' * (10 - int(offset / 50)), ']')                
...
if __name__ == "__main__":
    ...
    # asyncio.run(get_all_from_access_database(listing_num=listing_number))
    asyncio.run(get_all_from_applicant_database(listing_num=listing_number))
